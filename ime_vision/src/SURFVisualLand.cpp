...
static const char WINDOW[] = "SURFVisualLand";
...
public:
  ...
  void imageCb(const sensor_msgs::ImageConstPtr& msg)
  {
    ...
    surfDetector.detect(cv_ptr->image, this->keypoints);
    surfExtractor.compute(cv_ptr->image, this->keypoints, this->descriptors);
...
{
  ros::init(argc, argv, "image_converter_SURF");
  ImageConverter ic;
  ros::spin();
  return 0;
}
